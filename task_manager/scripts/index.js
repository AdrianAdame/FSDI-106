...
function displayTask(task){
    ...
    let card = `
        <div class="task-card" style="border: solid ${task.color};border-width: 1px 1px 1px 6px;" id="${task._id}">
            ...
            <div>
                <h5>${new Date(task.date || task.startDate || task.dueDate).toLocaleDateString()}</h5>
...
function saveTask(){
    ...
    //Build an object
    const newTask = new Task(title, date, description, color, status, budget, isImportant)
